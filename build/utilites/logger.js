...
var logger = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, filename, width, height, widthImage, url, fileimage, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                widthImage = _b.sent();
                if (!(width == widthImage.width && height == widthImage.height)) return [3 /*break*/, 3];
                url = filename;
